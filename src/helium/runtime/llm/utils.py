...
from vllm.vllm.tokenizers import TokenizerLike as AnyTokenizer
from vllm.vllm.tokenizers import get_tokenizer as vllm_get_tokenizer
...
def apply_chat_template(
    ...
    if strip_begin_of_text:
        bos_token = getattr(tokenizer, "special_tokens_map", {}).get("bos_token")
