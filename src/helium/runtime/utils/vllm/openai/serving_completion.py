...
logger = init_child_logger("serving_completion")
...
class OpenAIServingCompletion(OpenAIServing):
    ...
    async def create_completion(
        ...
        if self.benchmarking:
            benchmark_trackers = [BenchmarkRequestTracker() for _ in range(num_prompts)]
        else:
            benchmark_trackers = None
        ...
        if not self.benchmarking and request.stream:
    ...
    def request_output_to_completion_response(
        ...
        benchmark_trackers: list[BenchmarkRequestTracker] | None,
        request: CompletionRequest,
        request_id: str,
        created_time: int,
        model_name: str,
        ...
        if benchmark_trackers is not None:
            metrics = [tracker.finish() for tracker in benchmark_trackers]
        else:
            metrics = None
