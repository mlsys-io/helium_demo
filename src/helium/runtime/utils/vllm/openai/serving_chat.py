...
from vllm.vllm.entrypoints.openai.chat_completion.protocol import ChatCompletionRequest
from vllm.vllm.entrypoints.openai.engine.serving import (
    OpenAIServing,
...
from vllm.vllm.tool_parsers import ToolParser, ToolParserManager
from vllm.vllm.tool_parsers.mistral_tool_parser import MistralToolCall
...
class OpenAIServingChat(OpenAIServing):
    ...
    def __init__(
        ...
        *,
        ...
        self.reasoning_parser: Callable[[TokenizerLike], ReasoningParser] | None = None
        ...
        self.tool_parser: Callable[[TokenizerLike], ToolParser] | None = None
        if self.enable_auto_tools:
            try:
    ...
    async def chat_completion_full_generator(
        ...
        for output in final_res.outputs:
            ...
            if (not self.enable_auto_tools or not self.tool_parser) and (
                ...
                message = ChatMessage(
                    role=role, reasoning=reasoning_content, content=content
                )
