...
def add_request_output_delta(
    ...
    # Use the latest metrics (RequestStateStats in v0.16.0 is not mergeable field-by-field)
    new_metrics = res.metrics if res.metrics is not None else prev_res.metrics
