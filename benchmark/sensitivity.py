...
async def generate_tasks_from_system_params(
    ...
    trading_benchmark_settings = [
        ("fin_data", 8, 5, 50, 3, 30, 2, "trading_findata"),
        ("fin_data-4b", 8, 5, 50, 3, 30, 2, "trading_findata_4b_2r"),
        ("fin_data-12b", 8, 5, 50, 3, 30, 2, "trading_findata_12b_2r"),
        ("fin_data-16b", 8, 5, 50, 3, 30, 2, "trading_findata_16b_2r"),
        ("fin_data", 8, 5, 50, 3, 30, 3, "trading_findata_8b_3r"),
        ("fin_data", 8, 5, 50, 3, 30, 4, "trading_findata_8b_4r"),
        ("fin_data", 8, 5, 50, 3, 30, 5, "trading_findata_8b_5r"),
    ]
    for (
        dataset_name,
        num_stocks,
        ...
        helium = pd.DataFrame(
            list(
                itertools.product(
                    ...
                    [True],
                    # helium_prebuilt_file
                    ["./benchmark/prebuilt/{}/helium_{}.dill"],
                    # num_gpu_blocks_override
                    [None],
                )
            ),
